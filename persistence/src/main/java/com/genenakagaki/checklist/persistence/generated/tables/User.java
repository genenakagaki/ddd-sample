 ...
 */
package com.genenakagaki.checklist.persistence.generated.tables;


import com.genenakagaki.checklist.persistence.generated.Checklist;
import com.genenakagaki.checklist.persistence.generated.Keys;
...
public class User extends TableImpl<UserRecord> {
    ...
    /**
     * The reference instance of <code>checklist.user</code>
     */
    ...
    /**
     * The column <code>checklist.user.user_id</code>.
     */
    public final TableField<UserRecord, String> USER_ID = createField(DSL.name("user_id"), SQLDataType.CHAR(36).nullable(false), this, "");

    /**
     * The column <code>checklist.user.username</code>.
     */
    ...
    /**
     * The column <code>checklist.user.encoded_password</code>.
     */
    public final TableField<UserRecord, String> ENCODED_PASSWORD = createField(DSL.name("encoded_password"), SQLDataType.VARCHAR(128).nullable(false), this, "");

    /**
     * The column <code>checklist.user.created_at</code>.
     */
    ...
    /**
     * The column <code>checklist.user.updated_at</code>.
     */
    ...
    /**
     * Create an aliased <code>checklist.user</code> table reference
     */
    ...
    /**
     * Create a <code>checklist.user</code> table reference
     */
    public User() {
    ...
    public Schema getSchema() {
        return aliased() ? null : Checklist.CHECKLIST;
    }
    ...
    public List<UniqueKey<UserRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_USER_USERNAME);
    }
